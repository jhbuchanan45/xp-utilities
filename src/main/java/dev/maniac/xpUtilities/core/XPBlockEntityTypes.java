...
public class XPBlockEntityTypes {
    public static final BlockEntityType<XpExtractorBlockEntity> XP_EXTRACTOR_BLOCK_ENTITY_TYPE = registerXPTankStorageBlockEntity("xp_extractor", XP_EXTRACTOR_BLOCK::createBlockEntity, XP_EXTRACTOR_BLOCK);
